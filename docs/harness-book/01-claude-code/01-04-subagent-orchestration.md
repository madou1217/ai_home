...
<div class="rich-diagram-box">
  <div class="diagram-header-tag">Worktree Concurrency Pool</div>
  <div class="diagram-title"><span>🌳</span> Git Worktree 物理工作区并发隔离拓扑</div>
  <div class="chips-grid-3">
    <div class="tech-card blue"><div class="card-label">Subagent 1 (Worktree A)</div><div class="card-sub">.aih/worktrees/wt-1 (Branch: agent/t1)</div></div>
    <div class="tech-card purple"><div class="card-label">Subagent 2 (Worktree B)</div><div class="card-sub">.aih/worktrees/wt-2 (Branch: agent/t2)</div></div>
    <div class="tech-card green"><div class="card-label">Subagent 3 (Worktree C)</div><div class="card-sub">.aih/worktrees/wt-3 (Branch: agent/t3)</div></div>
  </div>
  <div class="flow-connector" style="margin-top:12px;">⬇️ 顺序检验 ➔ Squash &amp; Merge ➔ Fast-Forward on Main ⬆️</div>
</div>

...
<div class="rich-diagram-box">
  <div class="diagram-header-tag">Metacognition FSM</div>
  <div class="diagram-title"><span>🔄</span> 推理模型自我修正四步认知状态机</div>
  <div class="chips-grid-4">
    <div class="tech-card blue"><div class="card-label">1. 现象感知</div><div class="card-sub">吸收工具测试结果与退出码</div></div>
    <div class="tech-card orange"><div class="card-label">2. 差异与证伪分析</div><div class="card-sub">比对 Expected 与 Actual 差距</div></div>
    <div class="tech-card red"><div class="card-label">3. 根因假设与回溯</div><div class="card-sub">推翻前置假设，回退决策分支</div></div>
    <div class="tech-card green"><div class="card-label">4. 备选策略验证</div><div class="card-sub">生成全新补丁并运行微观测试</div></div>
  </div>
</div>

...
| 7 | 全站页面鸿蒙 6.1 化(L3512/L10139) | 2026-09-10 Playwright 逐页实测验收:**不通过**,4 项规范偏差(§二十四) | ⚠️ | `docs/dsh-harmonyos-evolution-matrix.md` 的 ✅ 均为自评;需逐页 Playwright 截图对照验收 |
...
| D2 | HOS 必须 6.1 版本 | ⚠️ | 规范文档按 6.1 编写,但实测实现与规范有 4 处偏差(§二十四);随 item 7 一并结案 |
...
| D5 | 全站每元素鸿蒙化(按钮/label/下拉/动画/间距/颜色) | ⚠️ | 元素级实测:字阶/圆角/色系已收口(§23.1),但按钮高度、选择器圆角、玻璃层 alpha 与规范不符(§二十四) |

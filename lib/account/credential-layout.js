...
function collectCredentialRelativePaths(provider) {
  ...
  // A caller-selected Kiro import directory contains one native SQLite artifact.
  // Keep this explicit path in sync with provider-storage-policy.js; no home scan.
  if (normalizedProvider === 'kiro') paths.push('data.sqlite3');

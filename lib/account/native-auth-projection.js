...
const PROVIDER_ARTIFACTS = Object.freeze({
  codex: Object.freeze([
    Object.freeze({ field: 'auth', path: ['.codex', 'auth.json'], format: 'json' })
  ]),
  claude: Object.freeze([
    Object.freeze({ field: 'credentials', path: ['.claude', '.credentials.json'], format: 'json' })
  ]),
  gemini: Object.freeze([
    Object.freeze({ field: 'oauthCreds', path: ['.gemini', 'oauth_creds.json'], format: 'json' }),
    Object.freeze({ field: 'googleAccounts', path: ['.gemini', 'google_accounts.json'], format: 'json', optional: true })
  ]),
  agy: Object.freeze([
    Object.freeze({ field: 'oauthToken', path: ['.gemini', 'antigravity-cli', 'antigravity-oauth-token'], format: 'json' }),
    Object.freeze({ field: 'email', path: ['.gemini', 'antigravity-cli', 'email.cache'], format: 'text', optional: true })
  ]),
  opencode: Object.freeze([
    Object.freeze({ field: 'auth', path: ['.local', 'share', 'opencode', 'auth.json'], format: 'json' })
  ])
});

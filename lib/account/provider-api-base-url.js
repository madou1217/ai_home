...
// zcode OAuth 计划账号的历史推理端点。relay 已于 2026-08-19 取消，此值仅作为
// 池内 OAuth 账号的 openaiBaseUrl 标识（http-utils 的 OAuth 探测分支凭 provider
// 判定走 billing/paas，不会用 baseUrl 拼推理 URL）。

...
const SUPPORTED_STANDARD_PROVIDERS = Object.freeze(['codex', 'gemini', 'claude', 'agy', 'opencode', 'grok', 'qoder', 'qodercn', 'kimi', 'kiro']);
const SUPPORTED_API_KEY_PROVIDERS = Object.freeze(['codex', 'gemini', 'claude', 'grok', 'kimi']);

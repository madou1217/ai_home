...
function createPtyRuntimeDeps(deps = {}) {
  return {
    ...
    resolveWindowsNodeShimLaunch: deps.resolveWindowsNodeShimLaunch,
    ...
    getAccountRuntimeDir: deps.getAccountRuntimeDir,
    getGatewayRuntimeDir: deps.getGatewayRuntimeDir,
    getLoginRuntimeDir: deps.getLoginRuntimeDir,

...
function createRootCommandContexts(deps = {}) {
  ...
  const serverEntryContext = {
    ...
    runServerProfileCommand: deps.runServerProfileCommand,
    formatServerProfileResult: deps.formatServerProfileResult
  };
  ...
  const globalSessionContext = {
    ...
    runCliPty: deps.runCliPty,
    restorePersistentSessions: deps.restorePersistentSessions
  };
  ...
  const backgroundContext = {
    ...
    consoleImpl: deps.consoleImpl,
    aiHomeDir: deps.aiHomeDir,
    startLocalServer: deps.startLocalServerModule,
    resolveServerOptions: deps.resolveBackgroundServerOptions,
    nodeContext,
    fabricContext
  };
...
function createRootRouterDeps(deps = {}) {
  return {
    ...
    runBackgroundSupervisor: deps.runBackgroundSupervisor,
...
function createRootDispatchWiring(deps = {}) {
  ...
  return createRootRouterDeps({
    ...
    backgroundContext: contexts.backgroundContext
  });
}

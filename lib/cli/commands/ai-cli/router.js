...
function runAiCliCommandRouter(cmd, args, context = {}) {
  ...
  const KNOWN_ACTIONS = new Set(['ls', 'set-default', 'login', 'auto', ...POLICY_ACTIONS, ...USAGE_ACTIONS, ...CLEANUP_ACTIONS, ...DELETE_ACTIONS, ...DELETE_ALL_ACTIONS, ...COUNT_ACTIONS, ...STATUS_ACTIONS]);

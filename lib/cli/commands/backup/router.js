...
const KNOWN_IMPORT_PROVIDERS = new Set(['codex', 'gemini', 'claude', 'agy', 'opencode', 'grok', 'qoder', 'qodercn']);
const SUB2API_EXPORT_PROVIDERS = new Set(['codex', 'gemini', 'claude', 'agy', 'grok']);

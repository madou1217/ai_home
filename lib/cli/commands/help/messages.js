...
\x1b[33mUsage:\x1b[0m
  ...
  aih node join <invite-url> \x1b[90mJoin this machine to a Control Plane as a remote node\x1b[0m
  ...
  aih node service status [--control-url URL] --node-id ID \x1b[90mShow supervised node readiness across relay and registry agent services\x1b[0m
  aih node service install <control-url> --node-id ID --token-file FILE --dry-run \x1b[90mPlan supervised relay + registry agent autostart\x1b[0m
  aih node service uninstall --node-id ID --dry-run \x1b[90mPlan supervised relay + registry agent autostart rollback\x1b[0m
...
\x1b[33mRemote Notes:\x1b[0m
  ...
  phones, PWAs, tablets, and other computers pair as Control Plane device clients

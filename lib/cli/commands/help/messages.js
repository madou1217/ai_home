...
\x1b[33mUsage:\x1b[0m
  ...
  aih ${cliName} set-default <id> [--restart-client] [--force-quit-client]${cliName === 'claude' ? ' [--desktop-mode <web|api>]' : ''} \x1b[90mSet default account; optionally restart/launch learned desktop client\x1b[0m

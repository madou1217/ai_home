...
\x1b[33mUsage:\x1b[0m
  ...
  aih codex|claude [args...] \x1b[90mRun the selected default profile and forward native CLI args\x1b[0m
  ...
  aih usage recalculate-costs \x1b[90mExplicitly recalculate historical costs with the current pricing catalog\x1b[0m
  aih usage scan --reindex-codex-forks \x1b[90mExplicitly rebuild deferred Codex fork usage history in this CLI process\x1b[0m
...
\x1b[33mAdvanced:\x1b[0m
  aih <cli> set-default <id> [--restart-client] [--force-quit-client]\x1b[90mSet the default account\x1b[0m
  aih codex|claude|opencode|kimi set-default [--restart-client]\x1b[90mSelect the built-in AIH Server profile\x1b[0m
  aih <cli> --restart-client [--force-quit-client]\x1b[90mRestart/launch the learned desktop client\x1b[0m
  aih claude set-default <id> --desktop-mode <web|api> --restart-client\x1b[90mLaunch isolated Claude Desktop in web or ai-home API mode\x1b[0m
...
\x1b[33mUsage:\x1b[0m
  ...
  aih ${cliName} set-default ${gatewayDefault ? '[<id>|.aih-server]' : '<id>'} [--restart-client] [--force-quit-client]${cliName === 'claude' ? ' [--desktop-mode <web|api>]' : ''} \x1b[90mSet default account${gatewayDefault ? ' or built-in AIH Server profile' : ''}\x1b[0m
  aih ${cliName} --restart-client [--force-quit-client] \x1b[90mRestart/launch the learned desktop client\x1b[0m
  ...
  aih ${cliName}${gatewayDefault ? ' [args...]' : ''}                 \x1b[90m${gatewayDefault ? 'Run the selected default (AIH Server if unset) and forward native CLI args' : 'Run with default account'}\x1b[0m
`);
  }

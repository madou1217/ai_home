...
\x1b[33mUsage:\x1b[0m
  ...
  aih codex|claude          \x1b[90mRun through the built-in AIH server profile (no numeric account)\x1b[0m
  aih gemini                \x1b[90mRun gemini with the default account (ID: 1)\x1b[0m
  aih <cli> auto            \x1b[90mRun the next schedulable account automatically\x1b[0m
  ...
  aih <cli> <id> up         \x1b[90mEnable one account for server pool / auto routing\x1b[0m
  aih <cli> <id> down       \x1b[90mDisable one account from server pool / auto routing\x1b[0m
  ...
  aih provider              \x1b[90mEnsure the built-in AIH provider endpoint is running\x1b[0m
...
\x1b[33mAdvanced:\x1b[0m
  ...
  aih codex set-mobile <id>       \x1b[90mSet Codex App account (API Key or ChatGPT OAuth)\x1b[0m
...
\x1b[33mUsage:\x1b[0m
  ...
  aih ${cliName} auto            \x1b[90mAuto-select next schedulable account\x1b[0m
  ...
  aih ${cliName} <id> up         \x1b[90mEnable one account for server pool / auto routing\x1b[0m
  aih ${cliName} <id> down       \x1b[90mDisable one account from server pool / auto routing\x1b[0m
  ...
  ${cliName === 'codex' ? 'aih codex set-mobile <id>       \x1b[90mSet Codex App account (API Key or ChatGPT OAuth)\x1b[0m' : ''}
  ...
  aih ${cliName}                 \x1b[90m${cliName === 'codex' || cliName === 'claude' ? 'Run through the built-in AIH server profile' : 'Run with default account'}\x1b[0m
`);
  }

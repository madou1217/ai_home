 ...
 */
function snapshotNativeSqliteFilesSync(sourceFile, destinationFile, options = {}) {
...
// Preserve the asynchronous public capture contract; planning needs the same
// audited staging boundary synchronously and must never open source SQLite.
async function snapshotNativeSqliteFiles(sourceFile, destinationFile, options = {}) {
  return snapshotNativeSqliteFilesSync(sourceFile, destinationFile, options);
}

module.exports = { snapshotNativeSqliteFiles, snapshotNativeSqliteFilesSync };

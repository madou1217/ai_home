...
const AI_CLI_CONFIGS = Object.freeze({
  ...
  opencode: Object.freeze({
    ...
    pkg: 'opencode-ai',
    // OpenCode owns provider credential collection (`opencode auth login`).
    // AIH isolates only XDG data auth.json; config/db/update state stays shared.
    // Do not auto-capture OPENCODE_* env into AIH `.aih_env.json`.

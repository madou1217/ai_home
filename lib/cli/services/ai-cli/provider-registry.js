...
const AI_CLI_CONFIGS = Object.freeze({
  ...
  claude: Object.freeze({
    ...
    desktopClient: Object.freeze({
      // Claude Desktop authenticates its claude.ai web view with session
      // cookies. Claude Code OAuth projection cannot sign in or switch that
      // independent web account, so set-default must not promise an auth reload.
  ...
  grok: Object.freeze({
    globalDir: '.grok',
    loginArgs: Object.freeze(['login', '--oauth']),
    binaryName: 'grok',
    pkg: '',
    envKeys: Object.freeze(['GROK_HOME', 'XAI_API_KEY']),
    desktopClient: Object.freeze({
      macos: Object.freeze({
        clientName: 'Grok',

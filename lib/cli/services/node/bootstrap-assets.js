...
const dir = String(process.env.AIH_HOME_DIR || process.env.AIH_HOME || path.join(os.homedir(), '.ai_home'));
const file = path.join(dir, 'server-config.json');
const defaults = { host: '127.0.0.1', port: 9527, apiKey: '', managementKey: '', openNetwork: false, proxyUrl: '', noProxy: '', modelsProbeAccounts: 2 };

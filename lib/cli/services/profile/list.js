      ...
      if (ids.length === 0) {
        ...
        while (cursor < ids.length) {
          ...
          batch.forEach((id) => {
            ...
            const quotaBadge = (!apiKeyMode && quotaStatus === 'exhausted')
            ...
            console.log(`  - Account ID: \x1b[36m${id}\x1b[0m  ${isDefault}[${statusStr}] [${accountStatus}] ${quotaBadge}\x1b[35m${accountInfo}\x1b[0m ${usageLabel} ${duplicateWarning}`);
          });
          cursor += batch.length;

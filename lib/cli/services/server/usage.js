...
\x1b[33mNotes:\x1b[0m
  ...
  - Server runs provider-specific adapters (codex/gemini/claude/agy) with dedicated base URLs.
  - Default provider mode is auto (routes by model hint: gpt/o* -> codex, gemini* -> gemini, claude* -> claude, agy*/antigravity* -> agy).

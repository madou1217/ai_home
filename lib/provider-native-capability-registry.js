...
const PROVIDER_NATIVE_CAPABILITIES = Object.freeze({
  ...
  grok: Object.freeze({
    ...
    config: Object.freeze({
      ...
      userSettings: Object.freeze(['config.toml']),
      projectSettings: Object.freeze(['.grok/config.toml']),
      cliFlags: Object.freeze(['--model', '--permission-mode'])
    }),
    sessions: Object.freeze({
      flags: Object.freeze(['--continue', '--resume', '--session-id']),
      nativeStore: 'sessions'
    }),
    mcp: Object.freeze({
      commands: Object.freeze(['mcp']),
    ...
    permissions: Object.freeze({
      flags: Object.freeze(['--sandbox', '--permission-mode']),
      modes: Object.freeze(['default', 'acceptEdits', 'auto', 'dontAsk', 'bypassPermissions', 'plan'])
    })
  }),
  kimi: Object.freeze({
    provider: 'kimi',
    config: Object.freeze({
      envHomeKeys: Object.freeze(['KIMI_CODE_HOME']),
      userSettings: Object.freeze(['config.toml']),
      projectSettings: Object.freeze([]),
      cliFlags: Object.freeze(['--model', '--plan'])
    }),
    sessions: Object.freeze({
      flags: Object.freeze(['-c', '-C', '/sessions']),
      nativeStore: 'sessions'
    }),
    mcp: Object.freeze({
    ...
    permissions: Object.freeze({
      flags: Object.freeze(['--yolo']),
      modes: Object.freeze(['default', 'yolo', 'plan'])
    })
  }),
  kiro: Object.freeze({
    provider: 'kiro',
    config: Object.freeze({
      envHomeKeys: Object.freeze(['KIRO_HOME']),
      userSettings: Object.freeze(['settings/mcp.json']),
      projectSettings: Object.freeze(['.kiro/settings/mcp.json']),
      cliFlags: Object.freeze(['--model', '--effort'])
    }),
    sessions: Object.freeze({
      flags: Object.freeze(['/rewind', '/chat new']),
      nativeStore: 'data.sqlite3'
    }),
    mcp: Object.freeze({
      commands: Object.freeze(['mcp']),
      configFiles: Object.freeze(['settings/mcp.json'])
    }),
    hooks: Object.freeze({
      files: Object.freeze([]),
      stopRequiresJsonStdout: false

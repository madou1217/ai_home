...
function resolveTerminalExecutable(definition, context = {}) {
  ...
  if (platform === CLIENT_PLATFORMS.WINDOWS && definition.id === TERMINAL_IDS.WINDOWS_TERMINAL) {
    const packageExecutable = resolveWindowsTerminalPackageExecutable(resolved);
...
function resolveWindowsTerminalPackageExecutable(context) {

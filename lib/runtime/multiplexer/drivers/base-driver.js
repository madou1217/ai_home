...
class BaseMultiplexerDriver {
   ...
   * @param {object} _options { spawnSyncImpl }
   ...
   * @param {object} _options { socket, shellCommand, cwd, env, useSystemdScope, spawnSyncImpl }
   ...
   * @param {string} _socket
   * @param {object} _options { fs, env, spawnSyncImpl }
   */
   ...
   * @param {string} _socket
   * @param {string} _text
   * @param {object} _options { appendNewline, spawnSyncImpl }
   * @returns {boolean}
   */

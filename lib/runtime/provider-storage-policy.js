...
const PROVIDER_STORAGE_POLICIES = Object.freeze({
  ...
  // Qoder global: encrypted credentials under the account config-dir root.
  // The runtimeDir IS the --config-dir value (no nested .qoder prefix).
  qoder: Object.freeze({
    authArtifacts: Object.freeze([
      Object.freeze({
        field: 'credentials',
        path: Object.freeze(['qoder-cli-credentials.json']),
        format: 'text'
      }),
      Object.freeze({
        field: 'keychainSalt',
        path: Object.freeze(['.keychain-salt']),
  ...
  // Qoder CN: same layout, CN credential prefix.
  qodercn: Object.freeze({
    authArtifacts: Object.freeze([
      Object.freeze({
        field: 'credentials',
        path: Object.freeze(['qoder-cli-cn-credentials.json']),
        format: 'text'
      }),
      Object.freeze({
        field: 'keychainSalt',

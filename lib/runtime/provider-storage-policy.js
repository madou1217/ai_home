...
const PROVIDER_STORAGE_POLICIES = Object.freeze({
  ...
  // Qoder global: encrypted credentials under ~/.qoder/.auth/user.
  // The runtimeDir IS the redirected HOME; CLI writes to $HOME/.qoder/.
  qoder: Object.freeze({
    authArtifacts: Object.freeze([
      Object.freeze({
        field: 'credentials',
        path: Object.freeze(['.qoder', '.auth', 'user']),
        format: 'text'
      }),
      Object.freeze({
        field: 'machineId',
        path: Object.freeze(['.qoder', '.auth', 'machine_id']),
        format: 'text',
        optional: true
      }),
      Object.freeze({
        field: 'dnsCache',
        path: Object.freeze(['.qoder', '.cache', 'dns-cache.json']),
        format: 'json',
        optional: true
      })
    ]),
  ...
  // Qoder CN: same layout under ~/.qoder-cn/.
  qodercn: Object.freeze({
    authArtifacts: Object.freeze([
      Object.freeze({
        field: 'credentials',
        path: Object.freeze(['.qoder-cn', '.auth', 'user']),
        format: 'text'
      }),
      Object.freeze({
        field: 'machineId',
        path: Object.freeze(['.qoder-cn', '.auth', 'machine_id']),
        format: 'text',
        optional: true
      }),
      Object.freeze({
        field: 'dnsCache',
        path: Object.freeze(['.qoder-cn', '.cache', 'dns-cache.json']),
        format: 'json',
        optional: true
      })
    ]),

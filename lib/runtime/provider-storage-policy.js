...
const PROVIDER_STORAGE_POLICIES = Object.freeze({
  ...
  workbuddy: Object.freeze({
    ...
    privateArtifacts: Object.freeze([
      ...
      Object.freeze({ path: Object.freeze(['.workbuddy-ai', 'settings.json']) }),
      Object.freeze({ path: Object.freeze(['.workbuddy-ai', '.mcp.json']) }),
      Object.freeze({ path: Object.freeze(['.workbuddy-ai', 'sessions']) }),
      Object.freeze({ path: Object.freeze(['Library', 'Keychains']) })
    ]),
  ...
  workbuddycn: Object.freeze({
    ...
    privateArtifacts: Object.freeze([
      ...
      Object.freeze({ path: Object.freeze(['.workbuddy', 'settings.json']) }),
      Object.freeze({ path: Object.freeze(['.workbuddy', '.mcp.json']) }),
      Object.freeze({ path: Object.freeze(['.workbuddy', 'sessions']) }),
      Object.freeze({ path: Object.freeze(['Library', 'Keychains']) })
    ]),

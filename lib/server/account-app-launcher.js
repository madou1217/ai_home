...
function createAccountAppLauncher(deps = {}) {
  ...
  function launchCliTerminal(provider, account) {
    ...
    const cliEntry = pathImpl.join(repoRoot, 'bin', 'ai-home.js');
...
function createAppEntryDetector(deps = {}) {
  ...
  function detect() {
    ...
    for (const definition of listProviderDefinitions()) {
      ...
      const cli = Boolean(binaryName && findOnPath([binaryName], env, fsImpl, pathImpl, platformKey));

...
function clearGrokAuthInvalidOnFreshCredential(provider, account, row, accountStateService) {
...
function mergePersistedRuntimeFields(accounts, provider, accountStateIndex, accountStateService) {
  ...
  return (Array.isArray(accounts) ? accounts : []).map((account) => {
    ...
    if (clearGrokAuthInvalidOnFreshCredential(provider, account, row, accountStateService)) {
      return account;
    }

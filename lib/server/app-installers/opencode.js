...
function buildOpenCodePagePlan(options = {}) {
  if (normalizePlatform(options) === 'win32') {
...
module.exports = createProviderInstaller({
  ...
  desktop: {
    darwin: { plans: [buildCaskPlan('opencode-desktop', 'Homebrew 安装 OpenCode Desktop')] },
    win32: { plans: [buildOpenCodePagePlan({ platform: 'win32' })] },

...
//
// 不过那份内嵌 CLI 不是闲置的：国内站（codebuddycn）把它当作零安装 CLI 来源
// （lib/server/app-installers/codebuddy-bundle-cli.js），并复用它与桌面端共享的
// 同一份主站登录态（provider-storage-policy 的 CODEBUDDY_CN_SHARED_AUTH_PATH）。
// 二者共同构成国内侧的安装 + 登录闭环。
//

...
function assertEncodedPayloadWithinLimit(base64) {
  // Reject oversized base64 before Buffer allocation. maxTotalBytes is the
  // largest valid decoded upload batch, including a possible single video.
  const maxEncodedLength = Math.ceil(limits.maxTotalBytes / 3) * 4;

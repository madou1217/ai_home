...
const { applyDocumentTokenBudget } = require('./chat-document-budget');
...
module.exports = { CHAT_INSTRUCTIONS, MAX_TURN_INPUT_CHARS, budgetedTurnInput, composeTurnPrompt, chatThreadParams, chatTurnParams, chatWorkingDirectory, injectableDocumentItems, isChatSession, needsDocumentInjection, oversizedTurnPrompt, sessionAttachmentTurnInput, sessionDocumentPrompt };

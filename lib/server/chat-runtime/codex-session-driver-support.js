...
function codexCapabilities(runtime) {
  return Object.freeze({
    ...
    capabilities: Object.freeze({
      ...
      'session.goal': support('emulated', 'aih_session_goal_projection'),
...
function clientOptions(options, session, runtime) {
  return {
    ...
    runtimeFingerprint: options.runtimeConfigRevision
      ? `${runtime.fingerprint}:${options.runtimeConfigRevision}` : runtime.fingerprint,
    runtimeScope: runtime.runtimeScope,
    spawnSyncImpl: options.spawnSyncImpl,
    wsImpl: options.wsImpl,
    ...(options.runtimeNamespace ? { runtimeNamespace: options.runtimeNamespace } : {}),
    ...(options.buildProviderEnvImpl ? { buildProviderEnvImpl: options.buildProviderEnvImpl } : {})
  };
}

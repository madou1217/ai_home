...
const { budgetedTurnInput, chatThreadParams, chatTurnParams, injectableDocumentItems, needsDocumentInjection, oversizedTurnPrompt, sessionAttachmentTurnInput } = require('./chat-harness-policy');
const {
  approvalMode,
  clientOptions,
  codexCapabilities,

...
function isFabricBrokerRouteAllowed(method, pathname) {
  ...
  if (requestMethod === 'GET') {
    return path === '/readyz'
      ...
      || path === '/v0/fabric/transport/readiness'
      ...
      || path === '/v0/node-rpc/device-node-session-artifact';
  }
  if (requestMethod === 'POST') {
    return path === '/v0/fabric/registry/nodes'
      || path === '/v0/fabric/registry/heartbeat'
      || path === '/v0/node-rpc/device-node-session-start'
      || path === '/v0/node-rpc/device-node-session-attach'
      || path === '/v0/node-rpc/device-node-session-command'
      || path === '/v0/node-rpc/device-node-session-ack'

...
// Fabric session actions are driven by the Provider contract capability, not by
// a second hand-maintained list. Adding a session runtime in the contract makes
// it appear in node gaps/actions automatically.
const DEFAULT_SESSION_PROVIDERS = Object.freeze(listProvidersByCapability('sessionRuntime'));

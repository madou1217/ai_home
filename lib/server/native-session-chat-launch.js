...
function resolveNativeCliLaunch(provider, options = {}) {
  ...
  if (normalizedProvider === 'workbuddy' || normalizedProvider === 'workbuddycn') {
    return resolveWorkbuddyNativeCli(normalizedProvider, { ...options, env, hostHomeDir: options.hostHomeDir || env.AIH_HOST_HOME || getRealHome() });
  }

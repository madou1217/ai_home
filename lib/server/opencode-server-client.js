...
async function fetchOpenCodeModels(options, account, timeoutMs = 8000, deps = {}) {
  ...
  const [goPayload, zenPayload] = await Promise.all([
    fetchOpenCodeGoJson('/models', { ...options, opencodeGoBaseUrl: OPENCODE_GO_BASE_URL }, account || {}, timeoutMs, deps).catch(() => null),
    fetchOpenCodeGoJson('/models', { ...options, opencodeGoBaseUrl: OPENCODE_ZEN_BASE_URL }, account || {}, timeoutMs, deps).catch(() => null)
  ]);

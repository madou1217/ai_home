...
// Shared quota input boundary. Only an actual number or a nonempty numeric
// string is evidence: Number(null/false/[]) is zero but is NOT exhausted quota.
// Strategies must call this before coercion, otherwise missingness is lost.

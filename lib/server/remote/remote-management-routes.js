...
const REMOTE_MANAGEMENT_ROUTES = Object.freeze([
  ...
  {
    key: 'usage.dashboard',
    localPath: 'usage/dashboard',
    remotePath: '/v0/management/usage/dashboard',
    method: 'GET',
    capability: 'usage',
    scope: 'usage:read'
  },
  ...
  {
    key: 'usage.requests',
    localPath: 'usage/requests',
    remotePath: '/v0/management/usage/requests',
    method: 'GET',
    capability: 'usage',
    scope: 'usage:read'
  },
  ...
  {
    key: 'usage.breakdown',
    localPath: 'usage/breakdown',
    remotePath: '/v0/management/usage/breakdown',
    method: 'GET',
    capability: 'usage',
    scope: 'usage:read'
  }

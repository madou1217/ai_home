...
function printConfigUsage() {
  console.log('\x1b[90mUsage:\x1b[0m aih server config [show|get|set] [--show-secrets] [--json] [--host <ip>] [--port <n>] [--client-key <key>] [--management-key <key>|--generate-management-key] [--open-network|--local-only]');
}

...
const SOURCE_FINGERPRINT_FILES = Object.freeze([
  ...
  'lib/server/model-alias-validation.js',
  'lib/server/model-account-index.js',
  'lib/server/model-capability-index.js',
  'lib/server/model-pool-narrowing.js',
  ...
  'lib/server/provider-usage-policy.js',
  'lib/server/provider-usage-policies.js',
  ...
  'lib/server/desktop-launch/index.js',
  'lib/server/desktop-launch/default-strategy.js',
  'lib/server/desktop-launch/agy-strategy.js',
  'lib/server/desktop-launch/kimi-strategy.js',
  'lib/server/desktop-launch/zcode-strategy.js',
  'lib/runtime/host-search-path.js',
  ...
  'lib/server/webui-provider-cli-upgrade-routes.js',
  'lib/server/provider-cli-upgrade-scheduler.js',
  'lib/server/provider-cli-upgrade/upgrade-channel.js',
  'lib/server/provider-cli-upgrade/upgrade-deps.js',
  'lib/server/provider-cli-upgrade/upgrade-error-classifier.js',
  'lib/server/provider-cli-upgrade/upgrade-install-roots.js',
  'lib/server/provider-cli-upgrade/upgrade-ledger.js',
  'lib/server/provider-cli-upgrade/upgrade-liveness.js',
  'lib/server/provider-cli-upgrade/upgrade-plan-builder.js',
  'lib/server/provider-cli-upgrade/upgrade-policy.js',
  'lib/server/provider-cli-upgrade/upgrade-post-install.js',
  'lib/server/provider-cli-upgrade/upgrade-publish-time.js',
  'lib/server/provider-cli-upgrade/upgrade-runner.js',
  'lib/server/provider-cli-upgrade/upgrade-verifier.js',
  'lib/server/provider-cli-upgrade/verifiers/codex.js'
]);

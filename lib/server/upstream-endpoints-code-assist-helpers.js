...
function writeCodeAssistFailure(writeJson, res, statusCode, detail, policy, protocol = 'openai') {
  if (policy && policy.kind === 'context_length_exceeded') {
  ...
  writeJson(res, statusCode, { ok: false, error: 'upstream_failed', detail });
}

module.exports = { createCodeAssistHelpers, writeCodeAssistFailure };

...
const PROVIDER_AUTH_MODE_MATRIX = Object.freeze({
  ...
  gemini: Object.freeze(['api-key', 'vertex-ai', 'oauth-browser']),
  agy: Object.freeze(['oauth-browser']),
  opencode: Object.freeze(['oauth-browser']),
  grok: Object.freeze(['oauth-browser', 'api-key']),
  kimi: Object.freeze(['oauth-browser', 'api-key']),
  kiro: Object.freeze(['oauth-browser']),
  qoder: Object.freeze(['oauth-browser', 'api-key']),
  qodercn: Object.freeze(['oauth-browser', 'api-key'])
});
...
function getOauthArtifactPath(job) {
  ...
  if (job.provider === 'grok') return path.join(String(job.configDir || ''), 'auth.json');
  if (job.provider === 'kimi') return path.join(String(job.configDir || ''), 'credentials', 'kimi-code.json');
  return '';
}

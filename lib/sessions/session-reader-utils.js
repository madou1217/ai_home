...
// CodeBuddy 家族四个 Provider 的会话都是单个 JSONL 文件（<configDir>/projects/<dir>/<id>.jsonl），
// 文件 size/mtime 就是有效的新鲜度键，因此可以走同一套消息缓存（与 claude/codex 同口径）。
const CACHEABLE_SESSION_MESSAGE_PROVIDERS = new Set(['claude', 'codex', 'gemini', 'agy', 'zcode', 'codebuddy', 'codebuddycn', 'workbuddy', 'workbuddycn']);

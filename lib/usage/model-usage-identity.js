...
// Attribution accepts every registered Provider. Billing aliases remain
// provider-specific below, but adding a Provider must not require editing this
// parser's identity allowlist.
const USAGE_PROVIDERS = new Set(listProviderIds());

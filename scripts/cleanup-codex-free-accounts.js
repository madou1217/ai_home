...
function checkLongResetQuotaDepleted(usagePath, resetDays) {
...
function main() {
  ...
  listNumericDirs(codexProfilesDir).forEach((id) => {
    ...
    if (checkLongResetQuotaDepleted(usagePath, args.resetDays)) reasons.push(`remaining_0_reset_gt_${args.resetDays}d`);

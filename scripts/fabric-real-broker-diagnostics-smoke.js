...
Usage:
  AIH_FABRIC_BROKER_TOKEN=<token> node scripts/fabric-real-broker-diagnostics-smoke.js [options]
...
Options:
  ...
  --token-file <path>   Read broker token from a remote/local file.
...
function readBrokerToken(options = {}, deps = {}) {
  ...
  if (options.tokenFile) {
    ...
    return String(readFileSync(options.tokenFile, 'utf8') || '').trim();
  }

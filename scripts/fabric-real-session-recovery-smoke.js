...
Usage:
  AIH_FABRIC_BROKER_TOKEN=<token> AIH_MANAGEMENT_KEY=<key> node scripts/fabric-real-session-recovery-smoke.js [options]
...
Options:
  ...
  --management-key <key>   Local server Management Key. Prefer AIH_MANAGEMENT_KEY to avoid argv leaks.

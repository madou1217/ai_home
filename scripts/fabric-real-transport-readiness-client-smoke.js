...
Options:
  --ai-home-dir <path>          AIH home containing control-plane-profiles.json.
...
This readiness check is read-only. It uses the local paired server profile
device token, checks that unauthenticated readiness is rejected, and then reads

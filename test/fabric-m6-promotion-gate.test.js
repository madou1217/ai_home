...
test('M6 promotion gate remote publish command uses node token-file instead of argv token', () => {
  ...
  assert.match(command, /'--token-file'/);
  assert.match(command, /aws-current-node\.token/);

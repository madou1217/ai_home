...
function agyUsage(capturedAt, models) {
  return {
    schemaVersion: 2,
...
test('runtime buckets expose accountRef without CLI identity fields', (t) => {
  ...
  assert.deepEqual(Object.keys(accounts).sort(), ['agy', 'claude', 'codex', 'gemini', 'opencode']);
...
test('runtime loading clears recoverable AGY auth blocks from DB OAuth metadata', (t) => {
  const fixture = createFixture(t);

                ...
                {isExpanded && (
                  <div className={styles.sessionList}>
                    ...
                    {displaySessions.map((session) => {
                      ...
                      const providerArchiveAction = resolveArchiveAction(lifecycleCapabilities, session.provider);
                      const archiveAction = isRunning && providerArchiveAction.visible
                        ? { ...providerArchiveAction, disabled: true, reason: 'session_lifecycle_active' }

...
export declare function supportsIncrementalSessionEvents(provider?: Provider | string): boolean;

export declare function supportsToolBoundaryQueue(provider?: Provider | string, apiKeyMode?: boolean): boolean;

export declare function supportsMidRunSteer(provider?: Provider | string, apiKeyMode?: boolean): boolean;

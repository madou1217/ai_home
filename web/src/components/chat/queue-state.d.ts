...
export declare function readPersistedQueue<T = unknown>(sessionKey: string): T[];

export declare function writePersistedQueue<T>(sessionKey: string, items: readonly T[]): void;

...
/** Provider 归属的产品站点。 */
export type ProviderSite = (typeof PROVIDER_DEFINITIONS)[number]['site'];

/** 产品族标识：同一产品族的国内站/国际站共享它。 */
export type ProviderFamily = (typeof PROVIDER_DEFINITIONS)[number]['family'];
